...
class FollowerPagingSource(
...
) : PagingSource<Int, DataXXXXXXXXX>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, DataXXXXXXXXX> {
        val pagePosition = params.key ?: 1

        return try {

            val response =
                repository.callGetRelationApi(
    ...
    override fun getRefreshKey(state: PagingState<Int, DataXXXXXXXXX>): Int? {
