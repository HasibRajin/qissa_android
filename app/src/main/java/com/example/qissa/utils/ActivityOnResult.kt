...
class ActivityOnResult<Input, Result> private constructor(
    ...
    companion object {
        ...
        ): ActivityOnResult<Input, Result> {
            return ActivityOnResult(caller, contract, onActivityResult)
        }
        ...
        fun registerActivityForResult(
            caller: ActivityResultCaller
        ): ActivityOnResult<Intent, ActivityResult> {
